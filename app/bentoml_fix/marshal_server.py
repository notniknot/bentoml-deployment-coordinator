...
def gunicorn_marshal_server(
    default_workers: int = Provide[BentoMLContainer.config.bento_server.microbatch.workers],
    ...
    default_max_request_size: int = Provide[BentoMLContainer.config.bento_server.max_request_size],
